...
module RGeo
  module Feature
    ...
    module GeometryCollection
      ...
      def num_geometries
        fail Error::UnsupportedOperation, "Method GeometryCollection#num_geometries not defined."
      end
      ...
      def geometry_n(_n_)
        fail Error::UnsupportedOperation, "Method GeometryCollection#geometry_n not defined."
      end
      ...
      def [](_n_)
        fail Error::UnsupportedOperation, "Method GeometryCollection#[] not defined."
      end
      ...
      def each(&_block_)
        fail Error::UnsupportedOperation, "Method GeometryCollection#each not defined."
      end
    end
  end
end
