...
module RGeo
  module Feature
    ...
    module Point
      ...
      def x
        fail Error::UnsupportedOperation, "Method Point#x not defined."
      end
      ...
      def y
        fail Error::UnsupportedOperation, "Method Point#y not defined."
      end
      ...
      def z
        fail Error::UnsupportedOperation, "Method Point#z not defined."
      end
      ...
      def m
        fail Error::UnsupportedOperation, "Method Point#m not defined."
      end
    end
  end
end
