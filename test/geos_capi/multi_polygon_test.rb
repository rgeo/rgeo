...
class GeosMultiPolygonTest < Minitest::Test # :nodoc:
  ...
  def invalid_multipolygon
    "MULTIPOLYGON (((0 1,2 1,2 2,0 2,0 1)), ((1 0,3 0,3 3,1 3,1 0)))"
  end

  def linework_multipolygon
    "MULTIPOLYGON (((1 2, 1 1, 0 1, 0 2, 1 2)), " \
      "((1 3, 3 3, 3 0, 1 0, 1 1, 2 1, 2 2, 1 2, 1 3)))"
  end

  def joined_polygon
    "POLYGON ((0 2, 1 2, 1 3, 3 3, 3 0, 1 0, 1 1, 0 1, 0 2))"
  end
end
