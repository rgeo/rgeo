...
if RGeo::Geos.ffi_supported?
  class GeosFFIMiscTest < Minitest::Test # :nodoc:
    ...
    def test_unary_union_mixed_collection
      ...
      WKT
      expected_geometrycollection = <<~WKT
        GEOMETRYCOLLECTION (
          POINT (60 140),
      ...
      WKT
      collection = @factory.parse_wkt(format_wkt(geometrycollection))
      expected = @factory.parse_wkt(format_wkt(expected_geometrycollection))
      geom = collection.unary_union
      if RGeo::Geos::Utils.ffi_supports_unary_union
