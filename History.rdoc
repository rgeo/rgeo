...
This is the first public alpha version of RGeo. With this version, we are soft-locking the API interfaces. They are still subject to possible change, but only if considered necessary.

With this alpha version, RGeo has been split into a core library and a set of optional modules. The following modules remain in the core "rgeo" gem:
* RGeo::Feature
* RGeo::CoordSys
* RGeo::Geos
* RGeo::Cartesian
...
Any additional modules will likely similarly be distributed as separate gems.

Other changes in this version:

* Proj4 wasn't building into the right location. Fixed.
