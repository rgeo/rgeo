...
* Geos-based implementations crashed when an operation resulted in an empty point, e.g. taking the centroid of an empty MultiPolygon. Fixed. Such operations now return nil (for the time being). (Reported by Ben Hughes)
